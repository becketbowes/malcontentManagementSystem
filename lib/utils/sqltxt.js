...
//add new employee
`INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES `//add employee values [${data.new_employee_firstname}, ${data.new_employee_lastname}, ${data.new_employee_role}, ${data.new_employee_manager.length}]
];
