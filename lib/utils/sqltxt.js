...
const addsql = [
//add new dept.
`INSERT INTO department (name) VALUE (${data.name})`,

//add new role
`INSERT INTO role (title, manager, salary, department_id) VALUES (${data.new_role}, ${data.new_role_manager} ${data.new_role_salary}, ${data.new_role_department.length})`

//add new employee
`INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUE (${data.new_employee_firstname}, ${data.new_employee_lastname}, ${data.new_employee_role}, ${data.new_employee_manager.length})`
];

const updatesql = [
//update role
`PUT INTO role ${something}`,

//update employee
`PUT INTO role ${something}`,

//delete department
`DESTROY department ${something}`,

//delete employee
`DESTROY employee ${something}`,
